...
token_reader = ad.deterministic_automata(
    [
        [1, 6, 200, 4, 2, 8, 10, 0, 200], #start
        [1, 201, 3, 201, 101, 101, 101, 101, 201], #-|ε, 0-9^n
        [1, 104, 104, 104, 104, 9, 104, 104, 200], #-
        [7, 202, 202, 202, 202, 202, 202, 202, 202], #-|ε, 0-9^n, .
        [4, 4, 4, 5, 4, 4, 4, 4, 4], #", any^n
        [203, 203, 203, 203, 103, 103, 103, 103, 203], #", any^n, "
        [6, 6, 200, 200, 100, 100, 100, 100, 200],#(a-z|A-Z|_)^n
        [7, 202, 202, 202, 202, 202, 102, 102, 202], #0-9^n, ., 0-9^n
        [104, 104, 104, 104, 104, 9, 104, 104, 200], #=|>|<
        [104, 104, 104, 104, 104, 200, 104, 104, 200], #(=|>|<|-|+|*|/|!)^2
        [104, 104, 104, 104, 104, 104, 104, 104, 200] #(|)|/|*|;|+|!|{|}
    ],
    {
